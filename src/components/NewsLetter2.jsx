    ...
    return (
        <div ref={newsletterRef} className={`w-full py-8 md:py-16 px-4 ${animationClasses(newsletterVisible)}`}>
            <div className="max-w-[1240px] mx-auto grid"> 
                <div className="">
                    <h1 className="text-xl md:text-2xl lg:text-4xl font-bold py-1 md:py-2"> Ready to work together?
                    <br></br></h1>
                    <p>We'd love to hear from you! Contact us below or send an email to <a href="mailto:Ceshleman@pmtsite.com" className="text-blue-500 hover:underline">Ceshleman@pmtsite.com</a></p>
                </div>
